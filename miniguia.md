...
UX não se limita à aparência de uma tela. A experiência envolve diferentes momentos da relação do usuário com o produto, incluindo sua utilização, aquisição, suporte e outros pontos de contato.

O UX Design busca planejar e modificar elementos que influenciam essa experiência.
